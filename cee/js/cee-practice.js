(function () {
    ...
    function renderBuilder() {
        ...
        $("ceePracticeBody").innerHTML = `<div class="cee-page-heading"><div><h1>Practice</h1><p>${format(bank.records.length)} questions / ${format(bank.records.filter(item => item.origin === "pdf").length)} from PDFs</p></div><span class="cee-practice-mode">Untimed</span></div>
